...
const teamUsers = [
    ...
    { id: 5, firstName: "Laura", lastName: "Homes", src: "https://github.com/shadcn.png", description: "Vice President of New Business Development" },
    { id: 6, firstName: "Laura", lastName: "Homes", src: "https://github.com/shadcn.png", description: "Vice President of Programming" },
    { id: 7, firstName: "Laura", lastName: "Homes", src: "https://github.com/shadcn.png", description: "Vice President of Professional Services" },
                    ...
                    <div className="grid grid-cols-2 gap-32 text-justify justify-between">
                        <div className="row-span-1 pt-8">
                            ...
                            <div className="mb-3 w-[500px] font-medium mt-4">
                                <p>Our user-friendly interface allows you to manage daily tasks seamlessly. Whether you’re scheduling activities or accessing student records, it’s all at your fingertips.</p>
                            </div>
