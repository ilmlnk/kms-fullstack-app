        ...
        <div className="h-[600px] bg-[#f4ede4] dark:bg-[#0d1425] text-white">
            <div className="text-center p-10">
                ...
                <div className="flex max-w-5xl gap-8 mx-auto group mt-16">
                    <div className="bg-black/10 dark:bg-white/10 group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 duration-500 cursor-pointer p-8 pb-16 pt-16 rounded-xl mix-blend-luminosity">
